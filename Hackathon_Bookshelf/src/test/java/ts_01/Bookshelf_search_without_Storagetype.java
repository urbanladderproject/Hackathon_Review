...
public class Bookshelf_search_without_Storagetype extends ExtentReport {
	...
	public void afterMethod(ITestResult result) throws Exception {
		...
		if (result.isSuccess())
			excel.reportToExcel("Bookshelf search without storage Test: SUCCESS",browsertype);
		else
			excel.reportToExcel("Bookshelf search without storage Test: FAILURE",browsertype);
	}

	@AfterClass
	public void closeBrowser() throws IOException {
		excel.reportToExcel("Bookshelf search without storage Test: ENDED",browsertype);
		// close the driver
